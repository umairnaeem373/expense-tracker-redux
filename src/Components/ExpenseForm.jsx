...
}} id="underline_select" name='type' className="block py-2.5 px-0 w-full text-sm text-gray-500 bg-transparent border-0 border-b-2 border-gray-200 appearance-none dark:text-gray-400 dark:border-gray-700 focus:outline-none focus:ring-0 focus:border-gray-200 peer">
<option  className='hidden' >Choose Type</option>
    <option className='text-lg' value='Income'>Income</option>
    <option selected className='text-lg' value="Expense">Expense</option>
</select>

    
<label for="underline_select" className="sr-only">Underline select</label>
<select onChange={handleChange} name='category' id="underline_select" className="block py-2.5 px-0 w-full text-sm text-gray-500 bg-transparent border-0 border-b-2 border-gray-200 appearance-none dark:text-gray-400 dark:border-gray-700 focus:outline-none focus:ring-0 focus:border-gray-200 peer">
    <option className='hidden' selected >Choose Category</option>
    <option className='text-lg' value="Car">Car</option>
    <option className='text-lg' value="Bills">Bills</option>
    <option className='text-lg' value="Deposit">Deposit</option>
    <option className='text-lg' value="Others">Misc.</option>
</select>
  ...
  type="number"  name="amount" id="amount" className="block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer" placeholder=" " required />
  ...
  <button onClick={(e)=>{
    ...
    }} className="text-white block mx-auto my-5 bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm w-full sm:w-auto px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">Create</button>
</form>
  )
}
